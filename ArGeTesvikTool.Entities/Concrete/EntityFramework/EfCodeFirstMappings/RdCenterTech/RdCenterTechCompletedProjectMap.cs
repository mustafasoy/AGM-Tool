...
{
    public class RdCenterTechCompletedProjectMap
    {
        public RdCenterTechCompletedProjectMap(EntityTypeBuilder<RdCenterTechCompletedProjectDto> entity)
        {
            entity.ToTable("RdCenterTechCompletedProjects");
